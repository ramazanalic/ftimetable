<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Flex.Master"
    CodeBehind="managebuilding.aspx.vb" Inherits="FlexTimeTable.managebuilding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3>
        Manage Buildings</h3>
    <asp:Literal ID="litSite" runat="server"></asp:Literal><asp:DropDownList ID="cboSites" AutoPostBack="true" runat="server">
    </asp:DropDownList>
    <asp:DropDownList ID="cboCampus" AutoPostBack="true" runat="server">
    </asp:DropDownList>
    <br />
     <asp:MultiView ID="mvBuilding" runat="server">
        <asp:View ID="vwGrid" runat="server">
      

    <asp:LinkButton ID="lnkCreate" runat="server">New Building</asp:LinkButton>
    <asp:GridView ID="grdBuilding" runat="server" AutoGenerateColumns="False" DataKeyNames="ID">
        <Columns>
